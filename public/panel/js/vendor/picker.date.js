...
!function(a) {
    ...
    c.prototype.create = function(a, c, d) {
        ...
        c == -1 / 0 || c == 1 / 0 ? f = c : b.isPlainObject(c) && e.isInteger(c.pick) ? c = c.obj : b.isArray(c) ? (c = new Date(c[0],c[1],c[2]),
        c = e.isDate(c) ? c : g.create().obj) : c = e.isInteger(c) || e.isDate(c) ? g.normalize(new Date(c), d) : g.now(a, c, d),
        {
    ...
    c.prototype.createRange = function(a, c) {
        ...
        return e.isInteger(a) || (a = f(a)),
        e.isInteger(c) || (c = f(c)),
        e.isInteger(a) && b.isPlainObject(c) ? a = [c.year, c.month, c.date + a] : e.isInteger(c) && b.isPlainObject(a) && (c = [a.year, a.month, a.date + c]),
        {
            from: f(a),
            to: f(c)
        }
    ...
    c.prototype.measure = function(a, b) {
        ...
        return e.isInteger(b) ? b = c.now(a, b, {
            rel: b
        }) : b ? "string" == typeof b && (b = c.parse(a, b)) : b = "min" == a ? -1 / 0 : 1 / 0,
        b
    }
    ,
    ...
    c.prototype.validate = function(a, c, d) {
        var f, g, h, i, j = this, k = c, l = d && d.interval ? d.interval : 1, m = -1 === j.item.enable, n = j.item.min, o = j.item.max, p = m && j.item.disable.filter(function(a) {
            if (b.isArray(a)) {
        ...
        if ((!d || !d.nav && !d.defaultValue) && (!m && j.disabled(c) || m && j.disabled(c) && (p || f || g) || !m && (c.pick <= n.pick || c.pick >= o.pick)))
            for (m && !p && (!g && l > 0 || !f && l < 0) && (l *= -1); j.disabled(c) && (Math.abs(l) > 1 && (c.month < k.month || c.month > k.month) && (c = k,
            l = l > 0 ? 1 : -1),
            c.pick <= n.pick ? (h = !0,
            l = 1,
        ...
        f = []) : c.map(function(a) {
            ...
            for (i = 0; i < g; i += 1) {
                ...
                if (d.isDateOverlap(h, a)) {
                    ...
                    c = a) : b.isArray(a) ? (c = a,
                    c[3] || c.push("inverted")) : e.isDate(a) && (c = [a.getFullYear(), a.getMonth(), a.getDate(), "inverted"]);
                    break
                }
            }
            if (c)
    ...
    c.prototype.nodes = function(a) {
        var b = this
          ...
          , n = function(a, b) {
            ...
            b.push(b.shift())),
            e.node("thead", e.node("tr", e.group({
                min: 0,
                max: d - 1,
                i: 1,
                node: "th",
                ...
                return [e.group({
                    ...
                    item: function(a) {
                        ...
                        return [e.node("div", a.date, function(b) {
                            return b.push(j.month == a.month ? c.klass.infocus : c.klass.outfocus),
