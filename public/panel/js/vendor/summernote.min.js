...
!function(t, e) {
    ...
    var i = function() {
        ...
        return t.prototype.render = function(t) {
            var o = k(this.markup);
            if (this.options && this.options.contents && o.html(this.options.contents),
            this.options && this.options.className && o.addClass(this.options.className),
            this.options && this.options.data && k.each(this.options.data, function(t, e) {
                o.attr("data-" + t, e)
            }),
            ...
            return this.callback && this.callback(o, this.options),
      ...
      , o = function(o, n) {
        return function() {
            ...
            return t && t.children && (e = t.children),
            new i(o,e,t,n)
        }
    }
      ...
      , p = o('<div class="note-color-palette"/>', function(t, e) {
        ...
        t.html(o.join("")),
        e.tooltip && t.find(".note-color-btn").tooltip({
    ...
    var N = {
        ...
        clusterBy: function(t, n) {
            return t.length ? S(t).reduce(function(t, e) {
                var o = x(t);
                return n(x(o), e) ? o[o.length] = e : t[t.length] = [e],
                t
            }, [[w(t)]]) : []
        },
        compact: function(t) {
    ...
    var A, R = navigator.userAgent, F = /MSIE|Trident/i.test(R);
    if (F) {
        var P = /MSIE (\d+[.]\d+)/.exec(R);
        P && (A = parseFloat(P[1])),
        (P = /Trident\/.*rv:([0-9]{1,}[.0-9]{0,})/.exec(R)) && (A = parseFloat(P[1]))
    }
    var L = /Edge\/\d+/.test(R)
      , H = !!window.CodeMirror;
    if (!H && E)
    ...
    function yt(t, e) {
        ...
        if (0 === t.offset) {
            ...
            n = bt(t.node) ? it(o = t.node.childNodes[t.offset - 1]) : (o = t.node,
            e ? 0 : t.offset - 1);
        return {
            node: o,
            offset: n
    ...
    function kt(t, e) {
        ...
        if (it(t.node) === t.offset) {
            ...
            n = bt(t.node) ? (o = t.node.childNodes[t.offset],
            0) : (o = t.node,
            e ? it(t.node) : t.offset + 1);
        return {
            node: o,
            offset: n
        }
    ...
    var Nt = {
        ...
        withClosestSiblings: function(t, e) {
            e = e || C.ok;
            var o = [];
            return t.previousSibling && e(t.previousSibling) && o.push(t.previousSibling),
            o.push(t),
        ...
        isVisiblePoint: function(t) {
            if (j(t.node) || !bt(t.node) || rt(t.node))
                return !0;
        ...
        splitPoint: function(t, e) {
            var o, n, i = e ? K : tt, r = lt(t.node, i), s = N.last(r) || t.node;
            n = i(s) ? (o = r[r.length - 2],
            s) : (o = s).parentNode;
            var a = o && xt(o, t, {
        ...
        replace: function(t, e) {
            if (t.nodeName.toUpperCase() === e.toUpperCase())
                return t;
            var o = St(e);
            return t.style.cssText && (o.style.cssText = t.style.cssText),
    ...
    function Et(t, e) {
        var o, n, i = t.parentElement(), r = document.body.createTextRange(), s = N.from(i.childNodes);
        for (o = 0; o < s.length; o++)
            if (!Nt.isText(s[o])) {
                if (r.moveToElementText(s[o]),
        ...
        if (0 !== o && Nt.isText(s[o - 1])) {
            ...
            for (var d = c.text.replace(/[\r\n]/g, "").length; d > l.nodeValue.length && l.nextSibling; )
                ...
                l = l.nextSibling;
            l.nodeValue;
            e && l.nextSibling && Nt.isText(l.nextSibling) && d === l.nodeValue.length && (d -= l.nodeValue.length,
            l = l.nextSibling),
            i = l,
            o = d
        }
    ...
    function At(t) {
        var s = function(t, e) {
          ...
          , o = s(t.node, t.offset);
        return e.moveToElementText(o.node),
    ...
    var Rt = function() {
        ...
        r.prototype.normalize = function() {
            var t = function(t, e) {
                if (Nt.isVisiblePoint(t) && !Nt.isEdgePoint(t) || Nt.isVisiblePoint(t) && Nt.isRightEdgePoint(t) && !e || Nt.isVisiblePoint(t) && Nt.isLeftEdgePoint(t) && e || Nt.isVisiblePoint(t) && Nt.isBlock(t.node) && Nt.isEmpty(t.node))
                    return t;
        ...
        r.prototype.nodes = function(o, t) {
            ...
            return Nt.walkPoint(e, r, function(t) {
                var e;
                Nt.isEditable(t.node) || (i ? (Nt.isLeftEdgePoint(t) && a.push(t.node),
                Nt.isRightEdgePoint(t) && N.contains(a, t.node) && (e = t.node)) : e = n ? Nt.ancestor(t.node, o) : t.node,
                e && o(e) && s.push(e))
            }, !0),
            N.unique(s)
        }
        ...
        r.prototype.expand = function(t) {
            ...
            if (!e && !o)
                return new r(this.sc,this.so,this.ec,this.eo);
            var n = this.getPoints();
            return e && (n.sc = e,
            n.so = 0),
            o && (n.ec = o,
            n.eo = Nt.nodeLength(o)),
        ...
        r.prototype.splitText = function() {
            var t = this.sc === this.ec
              , e = this.getPoints();
            return Nt.isText(this.ec) && !Nt.isEdgePoint(this.getEndPoint()) && this.ec.splitText(this.eo),
            Nt.isText(this.sc) && !Nt.isEdgePoint(this.getStartPoint()) && (e.sc = this.sc.splitText(this.so),
            e.so = 0,
            t && (e.ec = e.sc,
            e.eo = this.eo - this.so)),
        ...
        r.prototype.isLeftEdgeOf = function(t) {
            if (!Nt.isLeftEdgePoint(this.getStartPoint()))
                return !1;
            var e = Nt.ancestor(this.sc, t);
        ...
        r.prototype.wrapBodyInlineWithPara = function() {
            if (Nt.isBodyContainer(this.sc) && Nt.isEmpty(this.sc))
                return this.sc.innerHTML = Nt.emptyPara,
                new r(this.sc.firstChild,0,this.sc.firstChild,0);
            var t, e = this.normalize();
            if (Nt.isParaInline(this.sc) || Nt.isPara(this.sc))
                return e;
            if (Nt.isInline(e.sc)) {
        ...
        r.prototype.insertNode = function(t) {
            ...
            return o.rightNode ? o.rightNode.parentNode.insertBefore(t, o.rightNode) : o.container.appendChild(t),
            t
        }
        ,
      ...
      , Ft = {
        ...
        createFromSelection: function() {
            ...
            if (z.isW3CRangeSupport) {
                ...
                var c = Et(l, !0)
                  , d = Et(a, !1);
                Nt.isText(c.node) && Nt.isLeftEdgePoint(c) && Nt.isTextNode(d.node) && Nt.isRightEdgePoint(d) && d.node.nextSibling === c.node && (c = d),
                t = c.cont,
                e = c.offset,
                o = d.cont,
                n = d.offset
        ...
        createFromNode: function(t) {
            var e = t
              ...
              , n = t
              , i = Nt.nodeLength(n);
            return Nt.isVoid(e) && (o = Nt.listPrev(e).length - 1,
            e = e.parentNode),
            Nt.isBR(n) ? (i = Nt.listPrev(n).length - 1,
            n = n.parentNode) : Nt.isVoid(n) && (i = Nt.listPrev(n).length,
            n = n.parentNode),
            this.create(e, o, n, i)
        },
    ...
    var Ht = function() {
        ...
        t.prototype.applySnapshot = function(t) {
            ...
            null !== t.bookmark && Ft.createFromBookmark(this.editable, t.bookmark).select()
        }
        ,
        ...
        t.prototype.undo = function() {
            this.$editable.html() !== this.stack[this.stackOffset].contents && this.recordUndo(),
            0 < this.stackOffset && (this.stackOffset--,
            this.applySnapshot(this.stack[this.stackOffset]))
        }
        ,
      ...
      , Dt = function() {
        ...
        t.prototype.fromNode = function(t) {
            ...
            return e["font-size"] = parseInt(e["font-size"], 10),
            e
        }
        ,
        ...
        t.prototype.styleNodes = function(t, e) {
            ...
            if (t.isCollapsed())
                return [t.insertNode(Nt.create(o))];
            ...
            if (n) {
                ...
                return s.map(function(t) {
                    ...
                    return k.each(n, function(t, e) {
                        Nt.appendChildNodes(o, e.childNodes),
                        Nt.remove(e)
                    }),
                    N.head(e)
                })
        ...
        t.prototype.current = function(t) {
            ...
            return o.anchor = t.isOnAnchor() && Nt.ancestor(t.sc, Nt.isAnchor),
      ...
      , Bt = function() {
        ...
        t.prototype.wrapList = function(t, e) {
            ...
            r && (Nt.appendChildNodes(s, N.from(r.childNodes)),
            Nt.remove(r)),
            t
        }
        ,
            ...
            return k.each(t, function(t, e) {
                ...
                if ("LI" === i.parentNode.nodeName)
                    e.map(function(t) {
                        ...
                        r.nextSibling ? r.parentNode.insertBefore(t, r.nextSibling) : r.parentNode.appendChild(t),
                        e.length && (d.wrapList(e, i.nodeName),
                    ...
                    e = c ? Nt.listDescendant(a, Nt.isLi) : N.from(a.childNodes).filter(Nt.isLi),
                    !c && Nt.isList(i.parentNode) || (e = e.map(function(t) {
      ...
      , zt = function() {
        ...
        t.prototype.insertParagraph = function(t, e) {
            ...
            if (n) {
                ...
                var i = null;
                if (1 === this.options.blockquoteBreakingLevel ? i = Nt.ancestor(n, Nt.isBlockquote) : 2 === this.options.blockquoteBreakingLevel && (i = Nt.lastAncestor(n, Nt.isBlockquote)),
                i) {
                    o = k(Nt.emptyPara)[0],
                    Nt.isRightEdgePoint(e.getStartPoint()) && Nt.isBR(e.sc.nextSibling) && k(e.sc.nextSibling).remove();
      ...
      , Mt = function(t, h, p, i) {
        ...
        function k(t) {
            ...
            case Mt.where.Column:
                if (t.isColSpan)
                    return Mt.resultAction.SubtractSpanCount;
                break;
            case Mt.where.Row:
        ...
        function C(t) {
            ...
            case Mt.where.Column:
                if (t.isColSpan)
                    return Mt.resultAction.SumSpanCount;
                if (t.isRowSpan && t.isVirtual)
                    return Mt.resultAction.Ignore;
                break;
            case Mt.where.Row:
                if (t.isRowSpan)
                    return Mt.resultAction.SumSpanCount;
        ...
        ,
        t && t.tagName && ("td" === t.tagName.toLowerCase() || "th" === t.tagName.toLowerCase()) ? (f.colPos = t.cellIndex,
        t.parentElement && t.parentElement.tagName && "tr" === t.parentElement.tagName.toLowerCase() ? f.rowPos = t.parentElement.rowIndex : console.error("Impossible to identify start Row point.", t)) : console.error("Impossible to identify start Cell point.", t),
        function() {
    ...
    var Ot, Ut = function() {
        ...
        t.prototype.addRow = function(t, e) {
            for (var o = Nt.ancestor(t.commonAncestor(), Nt.isCell), n = k(o).closest("tr"), i = this.recoverAttributes(n), r = k("<tr" + i + "></tr>"), s = new Mt(o,Mt.where.Row,Mt.requestAction.Add,k(n).closest("table")[0]).getActionList(), a = 0; a < s.length; a++) {
                ...
                case Mt.resultAction.SumSpanCount:
                    ...
                    u++,
                    l.baseCell.setAttribute("rowSpan", u)
                }
            }
            if ("top" === e)
                n.before(r);
            ...
            for (var i = new Mt(o,Mt.where.Column,Mt.requestAction.Add,k(n).closest("table")[0]).getActionList(), r = 0; r < i.length; r++) {
                ...
                case Mt.resultAction.SumSpanCount:
                    if ("right" === e) {
                        ...
                        l++,
                        s.baseCell.setAttribute("colSpan", l)
                    } else
            ...
            for (var e = Nt.ancestor(t.commonAncestor(), Nt.isCell), o = k(e).closest("tr"), n = o.children("td, th").index(k(e)), i = o[0].rowIndex, r = new Mt(e,Mt.where.Row,Mt.requestAction.Delete,k(o).closest("table")[0]).getActionList(), s = 0; s < r.length; s++)
                if (r[s]) {
                    ...
                    case Mt.resultAction.AddCell:
                        ...
                        u.cells[n].innerHTML = "") : 2 === d && (u.insertBefore(h, u.cells[n]),
                    ...
                    case Mt.resultAction.SubtractSpanCount:
                        ...
                        l.rowIndex !== i && a.cellIndex === n && (a.innerHTML = "")) : 2 === d && (a.removeAttribute("rowSpan"),
                        l.rowIndex !== i && a.cellIndex === n && (a.innerHTML = "")));
                        continue;
                ...
                if (i[r])
                    ...
                    case Mt.resultAction.SubtractSpanCount:
                        ...
                        if (s.colSpan && 1 < s.colSpan) {
                            ...
                            s.cellIndex === n && (s.innerHTML = "")) : 2 === a && (s.removeAttribute("colSpan"),
        ...
        t.prototype.createTable = function(t, e, o) {
            ...
            return o && o.tableClassName && c.addClass(o.tableClassName),
            c[0]
        }
        ,
        ...
        function t(t) {
            ...
            for (o = 1; o <= 6; o++)
                ...
                this.context.memo("help.formatH" + o, this.lang.help["formatH" + o]);
            ...
            this.insertNode = this.wrapCommand(function(t) {
                u.isLimited(k(t).text().length) || (u.createRange().insertNode(t),
            ...
            this.createLink = this.wrapCommand(function(t) {
                ...
                if (!(0 < r && u.isLimited(r))) {
                    ...
                    u.options.onCreateLink ? o = u.options.onCreateLink(o) : /^\.?\/(.*)/.test(o) || (o = /^[A-Za-z][A-Za-z0-9+-.]*\:[\/\/]?/.test(o) ? o : "http://" + o);
                    var a = [];
                    if (s) {
            ...
            this.removeMedia = this.wrapCommand(function() {
                ...
                t.parent("figure").length ? t.parent("figure").remove() : t = k(u.restoreTarget()).detach(),
        ...
        return t.prototype.initialize = function() {
            ...
            this.$editable.on("keydown", function(t) {
                if (t.keyCode === Lt.code.ENTER && e.context.triggerEvent("enter", t),
                e.context.triggerEvent("keydown", t),
                t.isDefaultPrevented() || (e.options.shortcuts ? e.handleKeyMap(t) : e.preventDefaultEditableShortCuts(t)),
                e.isLimited(1, t))
                    return !1
            }).on("keyup", function(t) {
            ...
            this.$editable.on(z.inputEventName, C.debounce(function() {
                e.context.triggerEvent("change", e.$editable.html())
            }, 10)),
            this.$editor.on("focusin", function(t) {
        ...
        t.prototype.isLimited = function(t, e) {
            return t = t || 0,
            (void 0 === e || !(Lt.isMove(e.keyCode) || e.ctrlKey || e.metaKey || N.contains([Lt.code.BACKSPACE, Lt.code.DELETE], e.keyCode))) && (0 < this.options.maxTextLength && this.$editable.text().length + t >= this.options.maxTextLength)
        }
        ,
        t.prototype.createRange = function() {
            return this.focus(),
            Ft.create(this.editable)
        }
        ,
        ...
        t.prototype.insertImagesAsDataURL = function(t) {
            ...
            k.each(t, function(t, e) {
                var n, o = e.name;
                i.options.maximumImageFileSize && i.options.maximumImageFileSize < e.size ? i.context.triggerEvent("image.upload.error", i.lang.image.maximumFileSizeError) : (n = e,
                k.Deferred(function(o) {
        ...
        t.prototype.getSelectedText = function() {
            var t = this.createRange();
            return t.isOnAnchor() && (t = Ft.createFromNode(Nt.ancestor(t.sc, Nt.isAnchor))),
            t.toString()
        }
        ,
        ...
        t.prototype.fontStyling = function(t, e) {
            ...
            if (o) {
                ...
                o.isCollapsed()) {
                    var i = N.head(n);
                    i && !Nt.nodeLength(i) && (i.innerHTML = Nt.ZERO_WIDTH_NBSP_CHAR,
        ...
        t.prototype.getLinkInfo = function() {
            ...
            return e.length && (o.isNewWindow = "_blank" === e.attr("target")),
            o
        }
        ,
        ...
        function t(t) {
            ...
            this.$dropzone = k(['<div class="note-dropzone">', '  <div class="note-dropzone-message"/>', "</div>"].join("")).prependTo(this.$editor)
        }
        return t.prototype.initialize = function() {
        ...
        t.prototype.attachDragAndDropEvent = function() {
            ...
            this.documentEventHandlers.onDragenter = function(t) {
                ...
                e || n.length || !o || (i.$editor.addClass("dragover"),
            ...
            this.$dropzone.on("drop", function(t) {
                ...
                t.preventDefault(),
                n && n.files && n.files.length ? (i.$editable.focus(),
                i.context.invoke("editor.insertImagesOrCallback", n.files)) : k.each(n.types, function(t, e) {
                    var o = n.getData(e);
    ...
    var Vt = function() {
        ...
        t.prototype.activate = function() {
            var e = this;
            if (this.$codable.val(Nt.html(this.$editable, this.options.prettifyHtml)),
        ...
        t.prototype.deactivate = function() {
            ...
            o && this.context.triggerEvent("change", this.$editable.html(), this.$editable),
            this.$editable.focus(),
            ...
            this.options.airMode || this.options.disableResizeEditor ? this.destroy() : this.$statusbar.on("mousedown", function(t) {
                ...
                var o = n.$editable.offset().top - n.$document.scrollTop()
                  , e = function(t) {
                    ...
                    e = 0 < n.options.minheight ? Math.max(e, n.options.minheight) : e,
                    e = 0 < n.options.maxHeight ? Math.min(e, n.options.maxHeight) : e,
                    n.$editable.height(e)
                };
      ...
      , Gt = function() {
        ...
        t.prototype.update = function(t) {
            ...
            if (this.context.invoke("imagePopover.update", t),
            e) {
                var n = k(t)
                  , i = n.position()
                  , r = {
        ...
        t.prototype.replace = function() {
            if (this.lastWordRange) {
                ...
                if (e && (e[1] || e[2])) {
                    ...
                    this.context.options.linkTargetBlank && k(n).attr("target", "_blank"),
      ...
      , Xt = function() {
        function t(t) {
            ...
            this.options = t.options,
            this.lang = this.options.langInfo,
            this.invertedKeyMap = C.invertObject(this.options.keyMap[z.isMac ? "mac" : "pc"])
        }
        return t.prototype.representShortcut = function(t) {
            var e = this.invertedKeyMap[t];
            return this.options.shortcuts && e ? (z.isMac && (e = e.replace("CMD", "⌘").replace("SHIFT", "⇧")),
        ...
        t.prototype.isFontInstalled = function(t) {
            return this.fontInstalledMap.hasOwnProperty(t) || (this.fontInstalledMap[t] = z.isFontInstalled(t) || N.contains(this.options.fontNamesIgnoreCheck, t)),
            ...
            return this.ui.buttonGroup({
                ...
                children: [this.button({
                    ...
                    callback: function(t) {
                        ...
                        o && (e.css("background-color", "#FFFF00"),
                    ...
                    callback: function(o) {
                        ...
                        o.find("input[type=color]").each(function(t, e) {
                            k(e).change(function() {
                                ...
                                t.css("background-color", e).attr("aria-label", e).attr("data-value", e).attr("data-original-title", e),
                                t.click()
                            })
                        })
                    },
                    click: function(t) {
                        ...
                        if ("openPalette" === n) {
                            var r = e.find("#" + i)
                              ...
                              , l = r.val();
                            a.css("background-color", l).attr("aria-label", l).attr("data-value", l).attr("data-original-title", l),
                            s.prepend(a),
                            r.click()
        ...
        t.prototype.addToolbarButtons = function() {
            ...
            this.context.memo("button.fontname", function() {
                ...
                return k.each(t["font-family"].split(","), function(t, e) {
                    e = e.trim().replace(/['"]+/g, ""),
                    n.isFontDeservedToAdd(e) && -1 === k.inArray(e, n.options.fontNames) && n.options.fontNames.push(e)
                }),
        ...
        t.prototype.tableMoveHandler = function(t) {
            var e, o = k(t.target.parentNode), n = o.next(), i = o.find(".note-dimension-picker-mousecatcher"), r = o.find(".note-dimension-picker-highlighted"), s = o.find(".note-dimension-picker-unhighlighted");
            if (void 0 === t.offsetX) {
            ...
            i.data("value", l + "x" + c),
            3 < l && l < this.options.insertTableMaxSize.col && s.css({
                width: l + 1 + "em"
            }),
      ...
      , ee = function() {
        ...
        t.prototype.bindEnterKey = function(t, e) {
            t.on("keypress", function(t) {
                t.keyCode === Lt.code.ENTER && (t.preventDefault(),
                e.trigger("click"))
            })
        }
        ,
        ...
        t.prototype.show = function() {
            ...
            this.showLinkDialog(t).then(function(t) {
      ...
      , ne = function() {
        ...
        t.prototype.show = function() {
            var e = this;
            this.context.invoke("editor.saveRange"),
            this.showImageDialog().then(function(t) {
                e.ui.hideDialog(e.$dialog),
                e.context.invoke("editor.restoreRange"),
                "string" == typeof t ? e.options.callbacks.onImageLinkInsert ? e.context.triggerEvent("image.link.insert", t) : e.context.invoke("editor.insertImage", t) : e.options.callbacks.onImageUpload ? e.context.triggerEvent("image.upload", t) : e.context.invoke("editor.insertImagesAsDataURL", t)
            }).fail(function() {
                e.context.invoke("editor.restoreRange")
            })
        }
        ...
        t.prototype.showImageDialog = function() {
            ...
            return k.Deferred(function(e) {
                ...
                i.ui.onDialogShown(i.$dialog, function() {
                    ...
                    t.replaceWith(t.clone().on("change", function(t) {
      ...
      , se = function() {
        ...
        t.prototype.createVideoNode = function(t) {
            var e, o = t.match(/\/\/(?:www\.)?(?:youtu\.be\/|youtube\.com\/(?:embed\/|v\/|watch\?v=|watch\?.+&v=))([\w|-]{11})(?:(?:[\?&]t=)(\S+))?$/), n = t.match(/(?:www\.|\/\/)instagram\.com\/p\/(.[a-zA-Z0-9_-]*)/), i = t.match(/\/\/vine\.co\/v\/([a-zA-Z0-9]+)/), r = t.match(/\/\/(player\.)?vimeo\.com\/([a-z]*\/)*(\d+)[?]?.*/), s = t.match(/.+dailymotion.com\/(video|hub)\/([^_]+)[^#]*(#video=([^_&]+))?/), a = t.match(/\/\/v\.youku\.com\/v_show\/id_(\w+)=*\.html/), l = t.match(/\/\/v\.qq\.com.*?vid=(.+)/), c = t.match(/\/\/v\.qq\.com\/x?\/?(page|cover).*?\/([^\/]+)\.html\??.*/), d = t.match(/^.+.(mp4|m4v)$/), u = t.match(/^.+.(ogg|ogv)$/), h = t.match(/^.+.(webm)$/);
            if (o && 11 === o[1].length) {
                var p = o[1]
                  , f = 0;
                if (void 0 !== o[2]) {
                ...
                e = k("<iframe>").attr("frameborder", 0).attr("src", "https://instagram.com/p/" + n[1] + "/embed/").attr("width", "612").attr("height", "710").attr("scrolling", "no").attr("allowtransparency", "true");
            else if (i && i[0].length)
                e = k("<iframe>").attr("frameborder", 0).attr("src", i[0] + "/embed/simple").attr("width", "600").attr("height", "600").attr("class", "vine-embed");
            else if (r && r[3].length)
                e = k("<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>").attr("frameborder", 0).attr("src", "//player.vimeo.com/video/" + r[3]).attr("width", "640").attr("height", "360");
            else if (s && s[2].length)
                e = k("<iframe>").attr("frameborder", 0).attr("src", "//www.dailymotion.com/embed/video/" + s[2]).attr("width", "640").attr("height", "360");
            else if (a && a[1].length)
                e = k("<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>").attr("frameborder", 0).attr("height", "498").attr("width", "510").attr("src", "//player.youku.com/embed/" + a[1]);
        ...
        t.prototype.show = function() {
            ...
            this.context.invoke("editor.saveRange"),
            this.showVideoDialog(t).then(function(t) {
      ...
      , ce = function() {
        ...
        t.prototype.nodeFromItem = function(t) {
            ...
            return "string" == typeof n && (n = Nt.createText(n)),
            n
        }
        ,
        t.prototype.createItemTemplates = function(n, t) {
            ...
            return t.map(function(t, e) {
                ...
                return o.append(i.template ? i.template(t) : t + ""),
                o.data({
                    index: n,
                    item: t
                }),
        ...
        ,
        t.prototype.handleKeydown = function(t) {
            this.$popover.is(":visible") && (t.keyCode === Lt.code.ENTER ? (t.preventDefault(),
            this.replace()) : t.keyCode === Lt.code.UP ? (t.preventDefault(),
            this.moveUp()) : t.keyCode === Lt.code.DOWN && (t.preventDefault(),
            this.moveDown()))
        }
        ,
        ...
        t.prototype.createGroup = function(e, t) {
            ...
            return this.searchKeyword(e, t, function(t) {
                (t = t || []).length && (n.html(o.createItemTemplates(e, t)),
                o.show())
            }),
            n
        }
      ...
      , de = function() {
        ...
        return t.prototype.initialize = function() {
            return this.layoutInfo = this.ui.createLayout(this.$note, this.options),
            this._initialize(),
            this.$note.hide(),
            this
        }
        ...
        t.prototype.removeModule = function(t) {
            var e = this.modules[t];
            e.shouldInitialize() && (e.events && Nt.detachEvents(this.$note, e.events),
            e.destroy && e.destroy()),
    ...
    k.fn.extend({
        summernote: function() {
            ...
            i.langInfo = k.extend(!0, {}, k.summernote.lang["en-US"], k.summernote.lang[i.lang]),
            ...
            if (n.length) {
                ...
                if (e)
                    return r.invoke.apply(r, N.from(arguments));
