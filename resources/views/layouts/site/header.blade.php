                             ...
                             <li class="has-sub">
                                 ...
                                 <ul class="sub-menu">
                                     @foreach (getTrendingCategory() as $category)
                                         <li><a
                                                 href="{{ route('store-by-category', $category->slug) }}">{{ $category->name }}</a>
                                         </li>
                                     @endforeach
                         ...
                         <form action="#">
                             ...
                             <div class="right-create-acc">
                                 ...
                                 <div id="sys_warning_sms" class="warning-sms"
                                     ...
                                     style="display: block;">No disturb</div>
                             </div>
                         </form>
                         <i class="line-sep"></i>
                     </div>
         ...
         <ul>
             ...
             <li class="has-sub">
                 ...
                 <div class="mp-level" data-level="2">
                     ...
                     <ul>
                         @foreach (getTrendingCategory() as $category)
                             <li><a href="{{ route('store-by-category', $category->slug) }}">{{ $category->name }}</a>
                             </li>
                         @endforeach
                         <li><a href="{{ route('categories') }}">more</a></li>
                     </ul>
