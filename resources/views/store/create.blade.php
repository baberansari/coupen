            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-validation">
                        <form class="form-valide" role="form" action="{{route('stores.store')}}"
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" value="{{ old('store_sort_number') }}" class="form-control input-default"
                                                id="store_sort_number" name="store_sort_number" value="">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6 input-group">
                                            ...
                                            <div class="custom-file">
                                                <input type="file" id="store_featured_img"
                                                    name="store_featured_img" class="custom-file-input">
                                                <input type="text" id="store_featured_img"
                                                    name="store_featured_img" value="" hidden="">
                                                <label class="custom-file-label">Choose file</label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" value="{{ old('store_logo_alt_attribute') }}" class="form-control input-default"
                                                id="store_logo_alt_attribute" name="store_logo_alt_attribute"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" value="{{ old('store_name') }}" class="form-control input-default" id="store_name"
                                                name="store_name" data-validation="required" value="">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" value="{{ old('store_url') }}" class="form-control input-default" id="store_url"
                                                name="store_url" data-validation="required" value="">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" value="{{ old('store_slug') }}" class="form-control input-default" id="store_slug"
                                                name="store_slug" data-validation="required" value="">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" value="{{ old('store_affiliate_url') }}" class="form-control input-default"
                                                id="store_affiliate_url" name="store_affiliate_url" value="">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text"   value="{{ old('store_rating') }}" class="form-control input-default"
                                                id="store_rating" name="store_rating" value="">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" value="{{ old('store_heading') }}" class="form-control input-default"
                                                id="store_heading" name="store_heading" value="">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" value="{{ old('store_sidebar_heading') }}" class="form-control input-default"
                                                id="store_sidebar_heading" name="store_sidebar_heading"
                                                value="">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" value="{{ old('store_video_embedded_tittle') }}" class="form-control input-default"
                                                id="store_video_embedded_tittle" name="store_video_embedded_tittle"
                                                value="">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" value="{{ old('store_instagram_url') }}" class="form-control input-default"
                                                id="store_instagram_url" name="store_instagram_url"
                                                value="">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" value="{{ old('store_facebook_url') }}"  class="form-control input-default"
                                                id="store_facebook_url" name="store_facebook_url" value="">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" value="{{ old('store_twitter_url') }}"  class="form-control input-default"
                                                id="store_twitter_url" name="store_twitter_url" value="">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" value="{{ old('store_google_plus_url') }}" class="form-control input-default"
                                                id="store_google_plus_url" name="store_google_plus_url"
                                                value="">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" value="{{ old('store_youtube_url') }}" class="form-control input-default"
                                                id="store_youtube_url" name="store_youtube_url" value="">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" value="{{ old('store_pinterest_url') }}" class="form-control input-default"
                                                id="store_pinterest_url" name="store_pinterest_url"
                                                value="">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" value="{{ old('store_linkedin_url') }}" class="form-control input-default"
                                                id="store_linkedin_url" name="store_linkedin_url" value="">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input value="{{ old('store_home_page_visibility') }}"  name="store_home_page_visibility" type="checkbox"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input name="store_home_page_sidebar_visibility" value="{{ old('store_home_page_sidebar_visibility') }}" type="checkbox"
                                                data-toggle="toggle" data-width="200"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input value="{{ old('store_home_page_top_store') }}" name="store_home_page_top_store" type="checkbox"
                                                data-toggle="toggle" data-width="200"
                                                data-on="Display On Home Page Sidebar"
                                                data-off="Display On Home Page Sidebar" data-onstyle="success"
                                                data-offstyle="danger" value="1">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input value="{{ old('store_nav_bar_visibility') }}"  name="store_nav_bar_visibility" type="checkbox"
                                                data-toggle="toggle" data-width="200"
                                                data-on="Display On Top NavBar" data-off="Display On Top NavBar"
                                                data-onstyle="success" data-offstyle="danger" value="1">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input value="{{ old('store_month_visibility') }}" name="store_month_visibility" type="checkbox"
                                                data-toggle="toggle" data-width="200"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input value="{{ old('store_sitemap') }}" name="store_sitemap" type="checkbox" data-toggle="toggle"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input value="{{ old('seo_page_title') }}" type="text" class="form-control input-default"
                                                id="seo_page_title" name="seo_page_title" value="">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" value="{{ old('seo_meta_title') }}" class="form-control input-default"
                                                id="seo_meta_title" name="seo_meta_title" value="">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" value="{{ old('seo_meta_canonical') }}" class="form-control input-default"
                                                id="seo_meta_canonical" name="seo_meta_canonical" value="">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            </div><input value="{{ old('seo_meta_tags') }}"  type="text" data-role="tagsinput"
                                                class="form-control tags-input" id="seo_meta_tags"
                                                name="seo_meta_tags" value="" style="display: none;">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <select class="form-control" id="seo_meta_index" name="seo_meta_index"
                                                ...
                                                <option value="noindex, nofollow" {{ old('seo_meta_index') == 'noindex, nofollow' ? 'selected' : '' }}>noindex, nofollow</option>
                                                <option value="index, nofollow"  {{ old('seo_meta_index') == 'index, nofollow' ? 'selected' : '' }}>index, nofollow</option>
                                                <option value="noindex, follow" {{ old('seo_meta_index') == 'noindex, follow' ? 'selected' : '' }} >noindex, follow</option>
                                                <option value="index, follow" {{ old('seo_meta_index') == 'index, follow' ? 'selected' : '' }}>index, follow</option>
                                            </select>
